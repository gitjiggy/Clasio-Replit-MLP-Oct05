  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <main className="flex-1 md:overflow-hidden md:flex md:flex-col grid md:grid-none grid-rows-[22vh_16vh_auto] md:grid-rows-none overflow-hidden">
        ...
        <div className="overflow-y-auto md:overflow-visible bg-gradient-to-r from-slate-600 via-indigo-500 to-purple-500 dark:from-slate-700 dark:via-indigo-600 dark:to-purple-600 border-b border-border/30">
          ...
          <div className="px-4 md:px-6 py-3 md:py-4 border-b border-white/10">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-xs text-white/70" data-testid="document-count">
                  {isMainCategorySelected 
