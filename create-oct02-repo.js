...
const EXCLUDE_PATTERNS = [
  ...
  'create-oct02-repo.js',
  'fix-sha-conflicts.js',
  // Exclude test/debug files
  'test-duplicate.txt',
  'worker_test.log',
  'gz',
  // Exclude screenshots and temporary assets
  '*.png',
  'attached_assets',
  ...
  try {
    ...
    try {
      const { data } = await octokit.repos.createForAuthenticatedUser({
        name: repoName,
        description: 'Clasio - AI-Powered Document Management System (MLP Oct 02, 2025 - Refined UI with lighter color palette)',
        private: false,
        auto_init: false
      });
